<?php /* Smarty version 2.6.31, created on 2021-12-13 06:50:11
         compiled from /var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'headerTemplate', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 12, false),array('function', 'xlj', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 23, false),array('function', 'xlt', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 142, false),array('function', 'xla', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 148, false),array('function', 'math', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 182, false),array('modifier', 'attr', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 151, false),array('modifier', 'date_format', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 160, false),array('modifier', 'text', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 163, false),array('modifier', 'string_format', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 223, false),array('modifier', 'substr', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 316, false),array('modifier', 'js_escape', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 372, false),array('modifier', 'js_url', '/var/www/html/RevitHealthCare/interface/forms/vitals/templates/vitals/general_new.html', 460, false),)), $this); ?>
<html>
<head>
...
?>
                            ...
                            <tbody>
                                <?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                                    ...
                                    <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues p-2'><?php endif; ?>
                                            <input type="text" class="form-control" size='5' name='weight' id='weight_input' value="<?php if ($this->_tpl_vars['vitals']->get_weight() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_weight())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
...
?>
                                ...
                                <?php if ($this->_tpl_vars['units_of_measurement'] == 3): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                                    ...
                                    <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xlt(array('t' => 'kg'), $this);?>
                                            ...
                                            <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues p-2'><?php endif; ?>
                                            <input type="text" class="form-control" size='5' id='weight_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_weight() != 0): ?><?php echo smarty_function_math(array('equation' => "number * constant",'number' => $this->_tpl_vars['vitals']->get_weight(),'constant' => 0.45359237,'format' => ((is_array($_tmp="%.2f")) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp))), $this);?>
...
<?php endif; ?></td>
                                ...
                                <?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                                    ...
                                    <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues p-2'><?php endif; ?>
                                            <input type="text" class="form-control" size='5' name='height' id='height_input' value="<?php if ($this->_tpl_vars['vitals']->get_height() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_height())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
...
<?php endif; ?></td>
                                ...
                                <?php if ($this->_tpl_vars['units_of_measurement'] == 3): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                                    ...
                                    <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="unfocus"><?php else: ?><td><?php endif; ?><?php echo smarty_function_xlt(array('t' => 'cm'), $this);?>
                                            ...
                                            <?php if ($this->_tpl_vars['units_of_measurement'] == 1): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues p-2'><?php endif; ?>
                                            <input type="text" class="form-control" size='5' id='height_input_metric' value="<?php if ($this->_tpl_vars['vitals']->get_height() != 0): ?><?php echo smarty_function_math(array('equation' => "round(number * constant,1)",'number' => $this->_tpl_vars['vitals']->get_height(),'constant' => 2.54,'format' => ((is_array($_tmp="%.2f")) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp))), $this);?>
...
<?php endif; ?></td>
                                ...
                                <tr><td class="graph" id="bps"><?php echo smarty_function_xlt(array('t' => 'BP Systolic'), $this);?>
                                    ...
                                    <td class='currentvalues p-2'><input type="text" class="form-control" size='5' name='bps' id='bps_input' value="<?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_bps())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
"/></td>
                                <?php $_from = $this->_tpl_vars['results']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['result']):
?>
...
<?php endif; ?></td>
                                ...
                                <?php if ($this->_tpl_vars['units_of_measurement'] == 4 || $this->_tpl_vars['gbl_vitals_options'] > 0): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                                    ...
                                    <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues p-2'><?php endif; ?>
                                            <input type="text" class="form-control" size='5' name='head_circ' id='head_circ_input' value="<?php if ($this->_tpl_vars['vitals']->get_head_circ() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_head_circ())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
...
<?php endif; ?></td>
                                ...
                                <?php if ($this->_tpl_vars['units_of_measurement'] == 4 || $this->_tpl_vars['gbl_vitals_options'] > 0): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
                                    ...
                                    <?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues p-2'><?php endif; ?>
                                            <input type="text" class="form-control" size='5' name='waist_circ' id='waist_circ_input' value="<?php if ($this->_tpl_vars['vitals']->get_waist_circ() != 0): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['vitals']->get_waist_circ())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
