...
<body class="login">
  <form method="POST" id="login_form" autocomplete="off" action="../main/main_screen.php?auth=login&site=<?php echo attr($_SESSION['site_id']); ?>" target="_top" name="login_form">
      <div class="<?php echo $loginrow; ?>">
          ...
          <div class="<?php echo $logoarea; ?>" style="width:900px;">
            <?php $extraLogo = $GLOBALS['extra_logo_login']; ?>
            <?php if ($extraLogo) { ?>
            <div class="text-center">
              <span class="d-inline-block w-40"><?php echo file_get_contents($GLOBALS['images_static_absolute'] . "/Frame.svg"); ?></span>
            ...
            <?php } else { ?>
              <div class="mx-auto m-4 w-75" style="display:flex;justify-content:center;"> 
                  <?php echo file_get_contents($GLOBALS['images_static_absolute'] . "/Frame.svg"); ?>
              </div>
            <?php } ?>
            <div class="text-center login-title-label">
                ...
                <?php } ?>
            <p class="text-center lead font-weight-normal login-bg-text-color"><?php echo xlt('Revit Health Care'); ?></p>
          </div>
      </div>
